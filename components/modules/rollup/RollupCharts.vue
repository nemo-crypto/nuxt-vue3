	...
	<Flex direction="column" gap="0">
		<Flex align="center" justify="between" :class="$style.header">
			<Flex align="center" gap="8">
				...
				<Text size="20" weight="600" color="primary">Analytics</Text>
			</Flex>
		...
		<Flex direction="column">
			<Flex justify="between" gap="32" :class="$style.data">
				<Flex direction="column" gap="20" wide>
					<div :class="$style.dataContainer">
						<Text size="20" weight="400" color="primary">DA Usage</Text>
						<Flex ref="chartWrapperEl" direction="column" :class="$style.chart_wrapper">
							<Flex direction="column" justify="between" :class="[$style.axis, $style.y]">
								...
								<Text v-if="sizeSeries.length" size="12" weight="600" color="tertiary" :style="{
			opacity:
					...
					: 0,
							...
							<Flex :class="[$style.axis, $style.x]">
								<Flex align="end" justify="between" wide>
									<Text v-if="selectedPeriod.timeframe === 'day'" size="12" weight="600"
										color="tertiary">
										{{
			DateTime.now()
				...
				.toFormat("LLL dd")
									...
									<Text v-else size="12" weight="600" color="tertiary">
										{{ DateTime.now().minus({ hours: selectedPeriod.value }).set({
			minutes: 0
		}).toFormat("hh:mm a") }}
									</Text>

									<Text size="12" weight="600" color="tertiary">{{ selectedPeriod.timeframe === "day"
			?
			"Today" : "Now" }}</Text>
								</Flex>
							</Flex>
							...
							<Transition name="fastfade">
								<div v-if="showSeriesTooltip" :class="$style.tooltip_wrapper">
									<div :style="{ transform: `translate(${tooltipXOffset - 3}px, ${tooltipYDataOffset - 4}px)` }"
										:class="$style.dot" />
									<div :style="{ transform: `translateX(${tooltipXOffset}px)` }"
										:class="$style.line" />
									<div ref="badgeEl"
									...
									<Flex ref="tooltipEl"
										...
										<Flex align="center" gap="16">
											...
											<Text size="12" weight="600" color="primary"> {{ formatBytes(tooltipText) }}
											</Text>
										</Flex>
									</Flex>
								</div>
				...
				<Flex direction="column" gap="20" wide>
					<div :class="$style.dataContainer">
						<Text size="20" weight="400" color="primary">Blobs Count</Text>
						<Flex direction="column" :class="$style.chart_wrapper">
							<Flex direction="column" justify="between" :class="[$style.axis, $style.y]">
								...
								<Text v-if="pfbSeries.length" size="12" weight="600" color="tertiary" :style="{
			opacity:
								...
								<div v-if="showPfbTooltip" :class="$style.tooltip_wrapper">
									...
									<Flex ref="tooltipEl"
										...
										<Flex align="center" gap="16">
											...
											<Text size="12" weight="600" color="primary"> {{ abbreviate(tooltipText) }}
											</Text>
										</Flex>
									</Flex>
								</div>
			...
			<Flex justify="between" gap="32" :class="[$style.data, $style.dataButton]">
				<Flex direction="column" gap="20" wide>
					<div :class="$style.dataContainer">
						<Text size="20" weight="400" color="primary">Fee Paid</Text>
						<Flex direction="column" :class="$style.chart_wrapper_single">
							<Flex direction="column" justify="between" :class="[$style.axis, $style.y]">
								<Text v-if="feeSeries.length" size="12" weight="600" color="tertiary"
			...
			: tia(Math.max(...feeSeries.map((d) => d.value)), 2) }} NUB
								</Text>
								<Skeleton v-else-if="!feeSeries.length" w="32" h="12" />

								<Text v-if="feeSeries.length" size="12" weight="600" color="tertiary" :style="{
			opacity:
			...
			: tia(Math.round(Math.max(...feeSeries.map((d) => d.value)) / 2), 2) }} NUB
								</Text>
								...
								<div v-if="showFeeTooltip" :class="$style.tooltip_wrapper">
									...
									<Flex ref="tooltipEl"
										...
										<Flex align="center" gap="16">
											...
											<Text size="12" weight="600" color="primary"> {{ tia(tooltipText) }}
												NUB</Text>
										</Flex>
									</Flex>
								</div>
